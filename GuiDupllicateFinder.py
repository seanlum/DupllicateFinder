...
from PyQt5.QtWidgets import QApplication, QFileDialog, QMainWindow, QWidget, QPushButton, QMessageBox, QGridLayout, QLineEdit, QLabel
...
class DFLogger(metaclass=DFSingletonMeta):
    ...
    def __init__(self, base_log_level):
        ...
        logging_handlers = [ DFFlushFileHandler(DF_APPLICATION_LOG_FILENAME, mode='w') ]
...
class DFDataWidget(QWidget):
    ...
    def init_logger(self, logger):
        if (isinstance(logger, DFLogger)):
            ...
            self.logger = DFLogger(DF_APPLICATION_LOG_LEVEL)
...
class DFOptions(DFDataWidget):
    ...
    def init_ui(self):
        ...
        self.main_column.setGeometry(QtCore.QRect(10, 10, 600, 400))
...
class DFResults(DFDataWidget):
    ...
    def init_ui(self):
        ...
        self.results_column.setGeometry(QtCore.QRect(620, 10, 800, 400))
